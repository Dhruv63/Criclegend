...
void main() async {
  ...
  void printState() => print("Overs: $overs | Score: $totalRuns/$wickets | Batting: $striker (Str) - $nonStriker (Non)");
  ...
  void handleBall(int runs, {bool isWide = false, bool isNoBall = false, bool isWicket = false}) {
    // 1. Calculate Score
  ...
  assert(striker == "B", "FAIL: After 1 run on last ball, B should be facing next over.");
