...
class AppColors {
  ...
  static const Color secondary = Color(0xFF009688); // Teal for actions like "Start Match"
  static const Color secondaryDark = Color(0xFF00695C);
  
  static const Color background = Color(0xFFF5F5F5); // Light Grey
  static const Color surface = Colors.white;
  static const Color surfaceContainer = Color(0xFFEEEEEE); // Slightly darker for cards on white
  ...
  static const Color premiumRed = Color(0xFFB71C1C); 
}
