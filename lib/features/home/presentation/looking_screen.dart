...
class _LookingScreenState extends State<LookingScreen> {
  String?
  _selectedType; // null = All/Mumbai default, 'Opponent', 'Team', 'Player'
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildTab(
                  'Opponent',
                  _selectedType == 'Opponent',
                  () => setState(() => _selectedType = 'Opponent'),
                ),
                _buildTab(
                  'Team',
                  _selectedType == 'Team',
                  () => setState(() => _selectedType = 'Team'),
                ),
                _buildTab(
                  'Player',
                  _selectedType == 'Player',
                  () => setState(() => _selectedType = 'Player'),
                ),
              ],
            ),
          ),
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      _buildLookingCard(snapshot.data![index]),
                );
              },
            ),
          ),
