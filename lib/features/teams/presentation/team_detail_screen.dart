              ...
              children: [
                CircleAvatar(
                  ...
                  child: team['logo_url'] == null
                      ? const Icon(Icons.security, size: 40, color: Colors.grey)
                      : null,
                ),
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        isCap ? 'Captain' : (profile['role'] ?? 'Player'),
                      ),
                      trailing: isCap
  ...
  Future<void> _addPlayer(String userId) async {
    try {
      await ref
          ...
          .addPlayer(teamId: widget.teamId, userId: userId);
      if (mounted) {
