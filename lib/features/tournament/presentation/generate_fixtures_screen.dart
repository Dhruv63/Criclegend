...
class GenerateFixturesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GenerateFixturesScreen> createState() =>
      _GenerateFixturesScreenState();
}

class _GenerateFixturesScreenState
    extends ConsumerState<GenerateFixturesScreen> {
  ...
  Future<void> _generate() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Generated ${fixtures.length} matches starting from ${_selectedDate.toLocal().toString().split(' ')[0]}.\n\nSave to Database?',
        ),
        actions: [
          TextButton(
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Generate ${_selectedTeamIds.length > 1 ? 'Schedule' : ''}",
                      ),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.premiumRed,
                        foregroundColor: Colors.white,
